function handleRequest(request) {
  const messages = [
    ...
    { message: "人型は論外", background: "ヴァンパイアシリーズのかっこいいキャラについて。せっかくのヴァンパイアモノなのだから、という気持ちだろうか。ちなみに氏のメインキャラであるパイロンは、本来は圧倒的パワー・大きさを持つ不定形の宇宙生命体であるが、地球に敬意を表して征服するまでは人型で戦ってくれているという設定。セイヴァーではビシャモン(呪われた刀と甲冑に操られている人型のキャラクターだ。)"},

function handleRequest(request) {
  const messages = [
    { message: "あまりにも驚いてじゃんがら食いに行っちゃったよ", background: "秋葉原で朝イチの1プレイ目でサスカッチにいきなり負けたときのセリフ。たかが1敗のはずだが、氏にとっては事件であった。この後食べ終わって帰ってきて、今なお語り草となっている伝説の286連勝を記録することになる。ここで初めて、ヴァンパイアハンターの連勝数表示がMAX255であることが判明した。" },
    ...
    { message: "俺の徹底したプレイスタイルにけっこうムキムキきてたらしいけどね", background: "岐阜遠征時の平井モンがウメハラのパイロンに感じていたらしい気持ち。パイロン-モリガンは非常に厳しい組み合わせで、ほぼ負けなかったとか。しかし、平井モンがビシャモンを使うと互角だったそうだ。" },
    ...
    { message: "これ強Kが利きませんけど", background: "ヴァンパイアセイヴァーのロケテストで、圧倒的連勝をおさめたあとのセリフ。そういえば、途中からキックがいいはずのところでもパンチしか使っていなかったことに気づいた柏木氏は、あまりの実力差に恐れおののきゲーセンを飛び出してどこかにいってしまった。"},
    ...
    { message: "解けなかった方程式が解け出した", background: "ストリートファイターZERO3 の世界大会(アメリカ)にて。全米チャンプのアレックスにあと1敗で負けるところまで追い込まれるも、それまでの情報を糧になんとか取り返し、そのまま逆転優勝したときを振り返ってのセリフ。アレックスの空中オリコン発動の無敵時間に対して、対空をかわされると隙の大きい昇竜拳でなく空中投げにすればいいことに土壇場で気づいた。" }, 
    { message: "何か…すげー楽…だったんですけど", background: "闘劇05 ストリートファイター3 3rd Strike 優勝者インタビューにて。チームメイトのヌキに決勝まで全ての相手を倒してもらい、決勝戦の大将戦だけ勝利して美味しいところを全部もっていった後のセリフ。大会に出る前から、ユン(決勝の相手であった最強プレイヤー:K.Oの使用キャラクター)対策だけ練習するから、あとはヌキよろしく！(20キャラ近くいるけど。。)とか言ってたらしいが、本当にそうなった。"},
    { message: "人型は論外", background: "ヴァンパイアシリーズのかっこいいキャラについて。せっかくのヴァンパイアモノなのだから、という気持ちだろうか。ちtちなみに氏のメインキャラであるパイロンは、本来は圧倒的パワー・大きさを持つ不定形の宇宙生命体であるが、地球に敬意を表して征服するまでは人型で戦ってくれているという設定。セイヴァーではビシャモン(呪われた刀と甲冑に操られている人型のキャラクターだ。)"},
    { message: "負けないと思うんですけどね", background: "ストリートファイターZERO3 世界大会(アメリカ)の決勝戦、司会に対戦相手である全米チャンプ・アレックスへのコメントを求められて。"},
    { message: "負ける要素は無い", background: "ストリートファイターZERO3 全国大会決勝戦、司会に対戦相手のヌキへのコメントを求められて。ヌキとの豪鬼同キャラ対決のみに絞り、クラハシ氏に豪鬼を使ってもらってずっと練習していたらしい。ヌキが同じゲーセンに来たら捨てゲーして移動までしていたとか。ちなみに、根っからのスト2好きで知られるクラハシ氏はZERO3はメインでないためお願いする形であったが、要求されたお礼はスト2の対戦だったらしい。"},
  ...
  const html = `<html style="text-align: center;">
     <h1 style="font-size: 3rem;" >ウメハラの名言</h1>
